...
groceryStoreSchema.pre(/^find/, function (next) {
    this.find({ isDeleted: { $ne: true } });
    next();
});

groceryStoreSchema.pre('aggregate', function (next) {
...
groceryStoreSchema.methods.updateRating = async function (newScore) {
