...
const stores = [
    ...
    },
    {
        ...
        features: ['takeaway', 'parking'],
        tags: ['essentials', 'bulk', 'snacks'],
        featured: false,
        isVerified: true,
    ...
    },
    {
        ...
        features: ['vegan_options', 'parking', 'takeaway'],
        ...
        socials: {
            instagram: 'https://instagram.com/organichaven'
        }
    },
    {
        ...
        totalReviews: 100,
        priorityScore: 5,
        orderAcceptanceRate: 90,
        orderCancellationRate: 10,
        features: ['takeaway'],
        tags: ['convenience', 'fast', '24/7'],
        featured: false,
        isVerified: true,
        paymentMethods: ['cash', 'mobile_money'],
        deliveryRadius: 5,
    ...
    },
    {
        ...
        features: ['parking', 'takeaway', 'wheelchair_accessible'],
        tags: ['family', 'bulk', 'quality'],
        featured: false,
        isVerified: true,
        paymentMethods: ['cash', 'mobile_money'],
        deliveryRadius: 8,
        ...
        openingHours: {
            monday: { open: '08:30', close: '20:30', isClosed: false },
            tuesday: { open: '08:30', close: '20:30', isClosed: false },
            wednesday: { open: '08:30', close: '20:30', isClosed: false },
            thursday: { open: '08:30', close: '20:30', isClosed: false },
            friday: { open: '08:30', close: '21:30', isClosed: false },
            saturday: { open: '09:00', close: '21:30', isClosed: false },
            sunday: { open: '10:00', close: '18:00', isClosed: false }
        }
    },
    {
        ...
        location: {
            type: 'Point',
            coordinates: [-0.2000, 5.5600],
            address: 'Cantonments, Accra',
            city: 'Accra',
            area: 'Cantonments'
        },
        phone: '+233 24 555 1234',
        email: 'info@citymart.com',
        businessIdNumber: "BID-CM-006",
        deliveryFee: 8.00,
        minOrder: 30.00,
        rating: 4.7,
        categories: ['Fresh Produce', 'Dairy & Eggs', 'Beverages'],
        vendorType: 'grocery',
        status: 'approved',
        isOpen: true,
        isAcceptingOrders: true,
    ...
    },
    {
        ...
        location: {
            type: 'Point',
            coordinates: [-0.2200, 5.5900],
            address: 'Achimota, Accra',
            city: 'Accra',
            area: 'Achimota'
        },
        phone: '+233 27 777 8888',
        email: 'contact@valuegrocers.com',
        businessIdNumber: "BID-VG-007",
        deliveryFee: 4.00,
        minOrder: 15.00,
        rating: 4.4,
        categories: ['Pantry Staples', 'Snacks & Sweets', 'Household'],
        vendorType: 'grocery',
        status: 'approved',
        isOpen: true,
        isAcceptingOrders: true,
        ...
        orderCancellationRate: 8,
        features: ['parking'],
        tags: ['value', 'discount', 'bulk'],
        featured: false,
        isVerified: true,
        paymentMethods: ['cash', 'mobile_money'],
        deliveryRadius: 8,
    ...
    },
    {
        ...
        location: {
            type: 'Point',
            coordinates: [-0.0900, 5.6400],
            address: 'Spintex, Accra',
            city: 'Accra',
            area: 'Spintex'
        },
        phone: '+233 50 999 0000',
        email: 'hello@primesupermarket.com',
        businessIdNumber: "BID-PS-008",
        deliveryFee: 6.50,
        minOrder: 25.00,
        rating: 4.6,
        categories: ['Meat & Seafood', 'Bakery', 'Frozen'],
        vendorType: 'grocery',
        status: 'approved',
        isOpen: true,
        isAcceptingOrders: true,
        ...
        orderAcceptanceRate: 96,
        orderCancellationRate: 4,
        features: ['air_conditioned', 'parking', 'wheelchair_accessible'],
        tags: ['prime', 'quality', 'variety'],
        featured: true,
        isVerified: true,
        paymentMethods: ['cash', 'card', 'mobile_money'],
        deliveryRadius: 12,
    ...
    },
    {
        ...
        businessIdNumber: "BID-GB-009",
        deliveryFee: 9.00,
        minOrder: 35.00,
        rating: 4.9,
        categories: ['Fresh Produce', 'Organic', 'Healty'],
        vendorType: 'grocery',
        status: 'approved',
        isOpen: true,
        isAcceptingOrders: true,
        ...
        tags: ['green', 'organic', 'eco-friendly'],
        featured: true,
        isVerified: true,
        paymentMethods: ['cash', 'card', 'mobile_money'],
        deliveryRadius: 15,
    ...
    },
    {
        ...
        location: {
            type: 'Point',
            coordinates: [-0.1100, 5.6200],
            address: 'Teshie, Accra',
            city: 'Accra',
            area: 'Teshie'
        },
        phone: '+233 26 333 4444',
        email: 'support@dailyfresh.com',
        businessIdNumber: "BID-DF-010",
        deliveryFee: 5.50,
        minOrder: 18.00,
        rating: 4.3,
        categories: ['Dairy & Eggs', 'Bread', 'Beverages'],
        vendorType: 'grocery',
        status: 'approved',
        isOpen: true,
        isAcceptingOrders: true,
