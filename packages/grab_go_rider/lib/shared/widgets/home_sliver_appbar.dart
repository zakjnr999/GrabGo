...
class _HomeSliverAppbarState extends State<HomeSliverAppbar> {
  ...
  Future<void> _loadPartnerLevel() async {
    try {
      ...
      // Silently keep default — partner system may not be enrolled yet.
    }
  }
                                  ...
                                  child: Container(
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        ...
                                        SizedBox(width: 6.w),
                                        Text(
                                          partnerLevelLabel(_partnerLevel),
                                          style: TextStyle(
                                  ...
                                  children: [
                                    ...
                                    Row(
                                      ...
                                      children: [
                                        ...
                                        Flexible(
                                          child: Text(
                                            _isWalletLoading ? "..." : _balance.toStringAsFixed(2),
                                            style: TextStyle(
                                              color: Colors.white,
