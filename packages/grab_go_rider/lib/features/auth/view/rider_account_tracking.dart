...
class RiderAccountTracking extends StatefulWidget {
  const RiderAccountTracking({super.key});

  @override
  State<RiderAccountTracking> createState() => _RiderAccountTrackingState();
}

class _RiderAccountTrackingState extends State<RiderAccountTracking> {
  int currentStep = 1;
  ...
  Widget _buildCustomStepper(dynamic colors) {
    final steps = [
      ...
      },
      {
        ...
        'subtitle': 'Your account is active! You can now continue to your dashboard.',
        'icon': Assets.icons.check,
        'isCompleted': false,
        'isActive': false,
      },
