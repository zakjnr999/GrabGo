...
class _RegisterState extends State<Register> with SingleTickerProviderStateMixin {
  ...
  Future<void> _selectDate(BuildContext context) async {
    ...
    if (picked != null) {
      setState(() {
        bdayController.text = "${picked.day}/${picked.month}/${picked.year}";
      });
    }
  }
        ...
        leading: SizedBox(
          ...
          child: Material(
            ...
            child: InkWell(
              ...
              splashColor: colors.iconSecondary.withValues(alpha: 0.5),
              child: Padding(
