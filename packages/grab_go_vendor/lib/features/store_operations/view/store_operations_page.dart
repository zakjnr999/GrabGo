                          ...
                          child: Column(
                            children: visibleServices.map((service) {
                              return _ServiceToggleRow(
                                ...
                                onChanged: (value) =>
                                    viewModel.setServiceEnabled(service, value),
                              );
                            }).toList(),
                          ),
                        ),
                          ...
                          children: [
                            ...
                            SliderTheme(
                              data: SliderThemeData(
                                ...
                                inactiveTrackColor: colors.vendorPrimaryBlue
                                    .withValues(alpha: 0.16),
                                thumbColor: Colors.white,
                                overlayColor: colors.vendorPrimaryBlue
                                    .withValues(alpha: 0.16),
                                ...
                                inactiveTickMarkColor: colors.vendorPrimaryBlue
                      ...
                      AnimatedSwitcher(
                        ...
                        child: showCustomReason
                            ...
                            : const SizedBox.shrink(
                                key: ValueKey('custom_reason_empty'),
                              ),
                      ),
                      SizedBox(height: 12.h),
                      Text(
