      ...
      child: ListView(
        ...
        children: [
          ...
          _MoreOptionTile(
            ...
            onTap: () => Navigator.push(
              context,
              MaterialPageRoute(builder: (_) => const BasicAnalyticsPage()),
            ),
          ),
          _MoreOptionTile(
            ...
            onTap: () => Navigator.push(
              context,
              MaterialPageRoute(builder: (_) => const GrowthCenterPage()),
            ),
          ),
          _MoreOptionTile(
            ...
            onTap: () => Navigator.push(
              context,
              MaterialPageRoute(builder: (_) => const SchedulingCenterPage()),
            ),
          ),
          _MoreOptionTile(
            ...
            onTap: () => Navigator.push(
              context,
              MaterialPageRoute(builder: (_) => const FinanceCenterPage()),
            ),
          ),
          _MoreOptionTile(
            ...
            onTap: () => Navigator.push(
              context,
              MaterialPageRoute(builder: (_) => const IntegrationsCenterPage()),
            ),
          ),
          _MoreOptionTile(
