            ...
            children: [
              AnimatedBuilder(
                ...
                builder: (context, child) {
                  ...
                  return Positioned(
                    left: currentPosition + -1 - (_scrollController.hasClients ? _scrollController.offset : 0),
                    top: 4,
                    child: Container(
                      width: tabWidth - 1,
                        ...
                        child: Center(
                          child: AnimatedDefaultTextStyle(
                            ...
                            style: GoogleFonts.lato(
                              ...
                              color: isSelected ? AppColors.accentOrange : AppColors.mutedBrown,
                              height: 2,
                            ),
                            child: Text(tab, textAlign: TextAlign.center, overflow: TextOverflow.ellipsis, maxLines: 1),
                          ),
                        ),
                      ),
                    );
