...
class MobileNavigationDrawer extends StatelessWidget {
        ...
        children: [
          ...
          Expanded(
            child: ListView(
              ...
              children: [
                _buildNavItem(context, NavigationPage.dashboard, Assets.icons.home, 'Dashboard'),
                _buildNavItem(context, NavigationPage.restaurants, Assets.icons.chefHat, 'Restaurants'),
                _buildNavItem(context, NavigationPage.payments, Assets.icons.creditCard, 'Payments'),
                _buildNavItem(context, NavigationPage.orders, Assets.icons.cart, 'Orders'),
                _buildNavItem(context, NavigationPage.settings, Assets.icons.slidersHorizontal, 'Settings'),
              ],
            ),
          ),
          // Logout Section
  ...
  Widget _buildNavItem(BuildContext context, NavigationPage page, String icon, String title) {
